...
4. Commit the changes and write proper commit message
5. Make sure your code works with JavaScript.
6. Issue that pull request!
7. Wait for merge confirmation from Chirag Sir/
...
## Report bugs using Github's [issues](https://github.com/KDHarsh24/NavSarjan/issues)

All issues are to written here
